...
test('organisation events show colleague attribution and an accessible empty search state', async ({ page }) => {
...
test('direct access denial shows no event details and offers a return path', async ({ page }) => {
