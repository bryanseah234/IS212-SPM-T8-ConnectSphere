...
test('registration submits required fields without role and displays success', async ({ page }) => {
...
test('registration displays server field errors and allows correction', async ({ page }) => {
