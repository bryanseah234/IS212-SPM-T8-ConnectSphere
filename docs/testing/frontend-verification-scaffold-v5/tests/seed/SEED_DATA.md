...
Derived from the pre-conditions of all 237 test cases. Updated for backlog v4: sessions were withdrawn (BDR C-62), so seeded identifiers are events. Every account, venue and item below is named
