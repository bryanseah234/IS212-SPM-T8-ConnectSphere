...
// E02 - 13 cases. Generated from IS212_PROJECT_TEST_CASES.xlsx.
// Each test.fixme() is a specification. Remove .fixme once implemented.

test.describe('E02-S01 - Submit an event request', () => {

  /**
   * TC_E02S01_01
   * AC:      Scenario 1 - Complete request submitted
   * Sprint:  1.0
   *
   * Pre-conditions:
   ...
   */
  test.fixme('TC_E02S01_01 - Verify that submitting a request with every mandatory field complete should set its status to S', async ({ page }) => {
  ...
  /**
   * TC_E02S01_02
   * AC:      Scenario 2 - Missing mandatory fields blocked
   * Sprint:  1.0
   *
   * Pre-conditions:
   *   organiser_a@clienta.com is signed in; a new event request form is open
   ...
   */
  test.fixme('TC_E02S01_02 - Verify that submitting with any mandatory field empty should be blocked with every missing fiel', async ({ page }) => {
    // Steps from the specification:
  ...
  /**
   * TC_E02S01_03
   * AC:      Scenario 3 - Past date blocked
   * Sprint:  1.0
   *
   * Pre-conditions:
   ...
   */
  test.fixme('TC_E02S01_04 - Verify that selecting \'none required\' for equipment, layout, or registration setup should count', async ({ page }) => {
    // Steps from the specification:
   ...
   */
  test.fixme('TC_E02S01_05 - Verify that the event request form should require all ten mandatory fields before it can be con', async ({ page }) => {
    // Steps from the specification:
...
test.describe('E02-S02 - Save a draft event request', () => {

  /**
   * TC_E02S02_01
   * AC:      Scenario 1 - Draft saved and hidden from Coordinators
   * Sprint:  1.0
   *
   * Pre-conditions:
   ...
   */
  test.fixme('TC_E02S02_01 - Verify that saving a partially completed request as a draft should hide it from Event Coordinat', async ({ page }) => {
    // Steps from the specification:
  ...
  /**
   * TC_E02S02_02
   * AC:      Scenario 2 - Draft reopened with values restored
   * Sprint:  1.0
   *
   * Pre-conditions:
   ...
   */
  test.fixme('TC_E02S02_03 - Verify that deleting a draft should remove it from the list and stop it counting as an active r', async ({ page }) => {
    // Steps from the specification:
    // 1. Navigate to "My Drafts"
  ...
  /**
   * TC_E02S02_04
   * AC:      Scenario 4 - Completed draft submitted
   * Sprint:  1.0
   *
   * Pre-conditions:
   ...
   */
  test.fixme('TC_E02S02_04 - Verify that submitting a draft with every mandatory field complete should follow the normal sub', async ({ page }) => {
    // Steps from the specification:
   ...
   */
  test.fixme('TC_E02S02_05 - Verify that all of an Organiser\'s saved drafts should be listed and clearly distinguishable fro', async ({ page }) => {
    // Steps from the specification:
...
test.describe('E02-S03 - Match accessibility requirements to venue features', () => {

  /**
   * TC_E02S03_01
   * AC:      Scenario 1 - Predefined requirements stored
   * Sprint:  1.0
   *
   * Pre-conditions:
   ...
   */
  test.fixme('TC_E02S03_01 - Verify that selecting predefined accessibility requirements should store them with the request ', async ({ page }) => {
    // Steps from the specification:
   ...
   */
  test.fixme('TC_E02S03_02 - Verify that a free-text accessibility requirement should be stored and shown to the Coordinator', async ({ page }) => {
    // Steps from the specification:
   ...
   */
  test.fixme('TC_E02S03_03 - Verify that recorded predefined accessibility requirements should exclude or flag venues that c', async ({ page }) => {
    // Steps from the specification:
