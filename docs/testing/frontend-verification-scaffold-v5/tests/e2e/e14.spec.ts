...
// E14 - 7 cases. Generated from docs/testing/PROJECT TEST CASES.xlsx.
...
test.describe("E14-S02", () => {
  ...
  /**
   * TC_E14S02_01
   * AC:      E14-S02 - Scenario 1 (Status change recorded)
   * Sprint:  1.0
   *
   * Pre-conditions:
   ...
   */
  test.fixme("TC_E14S02_01 - Verify that an event status change should be recorded with the actor, action, affected event, and time", async ({ page }) => {
  ...
  /**
   * TC_E14S02_02
   * AC:      E14-S02 - Scenario 2 (Access denial recorded)
   * Sprint:  1.0
   *
   * Pre-conditions:
  ...
  /**
   * TC_E14S02_03
   * AC:      E14-S02 - Scenario 3 (Booking decision recorded)
   * Sprint:  1.0
   *
   * Pre-conditions:
   ...
   */
  test.fixme("TC_E14S02_03 - Verify that an approved venue booking should be recorded with the actor, action, affected records, and time", async ({ page }) => {
    // Steps from the specification:
  ...
  /**
   * TC_E14S02_04
   * AC:      E14-S02 - Scenario 4 (Deactivation recorded)
   * Sprint:  1.0
   *
   * Pre-conditions:
  ...
  /**
   * TC_E14S02_05
   * AC:      E14-S02 - Scenario 5 (Log entries immutable)
   * Sprint:  1.0
   *
   * Pre-conditions:
   ...
   */
  test.fixme("TC_E14S02_06 - Verify that a rejected venue booking should be recorded with the actor, action, affected records, and time", async ({ page }) => {
    // Steps from the specification:
   ...
   */
  test.fixme("TC_E14S02_07 - Verify that a released venue booking should be recorded with the actor, action, affected records, and time", async ({ page }) => {
    // Steps from the specification:
